<div
    class="shadow-md bg-base-100 text-base-content sticky top-0 z-30 flex h-16 w-full justify-center bg-opacity-90 backdrop-blur transition-shadow duration-100 [transform:translate3d(0,0,0)] ">
    <nav class="navbar w-full">
        <div class="flex flex-1 md:gap-1 lg:gap-2"><span
            ...
            <div class="flex items-center gap-2 lg:hidden"><a data-sveltekit-preload-data href="/"
                    aria-current="page" aria-label="Bentre-shtt" class="flex-0 btn btn-ghost gap-1 px-2 md:gap-2"><span
                        class="font-title text-base-content text-lg md:text-2xl">Bentre-shtt</span></a>
            </div>
