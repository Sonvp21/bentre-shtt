    ...
    <div class="flex-grow w-full p-5">
        ...
        <div class="overflow-x-auto bg-white rounded-lg mt-5">
            <div class="overflow-x-auto p-5">
                <form action="{{ route('admin.industrial_design_types.update', $industrialDesignType) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-span-1">
                            <label class="form-control w-[95%]">
                                ...
                                <input type="text" name="name" placeholder="Nhập vào"
                                    value="{{ old('name', $industrialDesignType->name) }}"
                    ...
                    <div class="flex gap-4 justify-center">
                        ...
                        <a href="{{ route('admin.industrial_design_types.index') }}" class="btn btn-outline btn-error !min-h-9 h-9">Huỷ</a>
                    </div>
                </form>
            </div>
        </div>
