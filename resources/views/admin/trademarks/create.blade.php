                    ...
                    <div class="grid grid-cols-3 gap-4 !m-0">
                        ...
                        <div class="col-span-2">
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="text" name="contact" placeholder="09876... or nguyenvana@gmail.com"
                                    value="{{ old('contact') }}"
                        ...
                        <div>
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="date" name="out_of_date" placeholder="Select Patent Out of Date"
                                    value="{{ old('out_of_date') }}"
