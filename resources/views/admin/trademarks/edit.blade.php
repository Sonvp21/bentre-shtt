                        ...
                        <div class="col-span-2">
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <textarea name="description" id="description"
                                    class="form-textarea input input-bordered w-full @error('description') border-red-500 @enderror" rows="4">{{ old('description', $trademark->description) }}</textarea>
                                @error('description')
                                    <span class="text-xs text-red-500">{{ $message }}</span>
                                @enderror
                            </label>
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="text" name="contact" placeholder="Nhập vào"
                                    value="{{ old('contact', $trademark->contact) }}"
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                @if ($trademark->hasMedia('document_trademark'))
                                    <div>
                                        <span class="text-sm font-medium text-gray-700">Tệp hiện tại:</span>
                                        <a id="currentDocumentLink"
                                            href="{{ $trademark->getFirstMedia('document_trademark')->getUrl() }}"
                                            class="text-blue-600 hover:underline">
                                            {{ $trademark->getFirstMedia('document_trademark')->file_name }}
                                        </a>
                                        <label for="document"
                            ...
                            <div class="form-group items-center space-x-6">
                                ...
                                <div class="shrink-0">
                                    @php
                                        $imageUrl = $trademark->getFirstMediaUrl('trademark_image');
                        ...
                        <div>
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="text" name="application_number" placeholder="Nhập vào"
                                    value="{{ old('application_number', $trademark->application_number) }}"
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="date" name="submission_date" placeholder="Select Submission Date"
                                    value="{{ old('submission_date', $trademark->submission_date ? \Carbon\Carbon::parse($trademark->submission_date)->format('Y-m-d') : '') }}"
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <select name="submission_status"
                                    ...
                                    <option value="1"
                                        {{ old('submission_status', $trademark->submission_status) == '1' ? 'selected' : '' }}>
                                        Đang xử lý</option>
                                    <option value="2"
                                        {{ old('submission_status', $trademark->submission_status) == '2' ? 'selected' : '' }}>
                                        Đã
                                        cấp</option>
                                    <option value="3"
                                        {{ old('submission_status', $trademark->submission_status) == '3' ? 'selected' : '' }}>
                                        Bị
                                        từ chối</option>
                                </select>
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="date" name="out_of_date" placeholder="Select trademark Out of Date"
                                    value="{{ old('out_of_date', $trademark->out_of_date ? \Carbon\Carbon::parse($trademark->out_of_date)->format('Y-m-d') : '') }}"
