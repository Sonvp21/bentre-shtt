            ...
            function exportDataAndSubmit(action) {
                ...
                rows.forEach(row => {
                    const rowData = {
                        ...
                        code: row.querySelector('td:nth-child(5)').innerText.trim(),
                        name: row.querySelector('td:nth-child(6)').innerText.trim(),
                        owner: row.querySelector('td:nth-child(7)').innerText.trim(),
                        description: row.querySelector('td:nth-child(8)').innerText.trim(),
                        address: row.querySelector('td:nth-child(9)').innerText.trim(),
                        contact: row.querySelector('td:nth-child(10)').innerText.trim(),
                        application_number: row.querySelector('td:nth-child(11)').innerText.trim(),
                        submission_date: row.querySelector('td:nth-child(12)').innerText.trim(),
                        submission_status_text: row.querySelector('td:nth-child(13)').innerText.trim(),
                        publication_number: row.querySelector('td:nth-child(14)').innerText.trim(),
                        publication_date: row.querySelector('td:nth-child(15)').innerText.trim(),
                        out_of_date: row.querySelector('td:nth-child(16)').innerText.trim()
                    };
                    data.push(rowData);
                });
