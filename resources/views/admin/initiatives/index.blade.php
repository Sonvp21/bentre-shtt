    ...
    <div class="flex-grow w-full p-5">
        <div class="text-gray-800 text-sm font-semibold leading-tight flex">
            ...
            <div class="flex ml-auto">
                <form action="{{ route('admin.initiatives.index') }}" method="GET" class="w-full">
                    <div class="flex items-center justify-between">
                        <a class="btn flex" href="{{ route('admin.initiatives.create') }}">
                                ...
                                <tr>
                                    ...
                                    <td class="flex justify-around">
                                        ...
                                        <form id="delete-form-{{ $initiative->id }}"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                onclick="return confirm('Bạn có chắc muốn xoá sáng kiến này?')"
                                                class="p-0">
