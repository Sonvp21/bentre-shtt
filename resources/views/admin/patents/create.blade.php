        ...
        <div class="overflow-x-auto bg-white rounded-lg mt-5">
            ...
            <form action="{{ route('admin.patents.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4 px-3">
                    ...
                    <div class="grid grid-cols-3 gap-4 !m-0">
                        ...
                        <div class="col-span-2 ...">
                            <label class="form-control w-[95%]">
                                ...
                                <input type="text" name="code" placeholder="Nhập vào" value="{{ old('code') }}"
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="text" name="legal_representative"
                                    placeholder="Enter Legal Representative" value="{{ old('legal_representative') }}"
                        ...
                        <div>
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <input type="date" name="patent_out_of_date"
                                    placeholder="Select Patent Out of Date" value="{{ old('patent_out_of_date') }}"
                            ...
                            <label class="form-control w-[95%]">
                                ...
                                <select name="patent_status"
                                    ...
                                    <option value="">Lựa chọn</option>
                                    <option value="1" {{ old('patent_status') == '1' ? 'selected' : '' }}>Hiệu
                                        lực</option>
                                    <option value="2" {{ old('patent_status') == '2' ? 'selected' : '' }}>Hết hạn
                                    </option>
                                    <option value="3" {{ old('patent_status') == '3' ? 'selected' : '' }}>Bị huỷ
                                    </option>
                                </select>
                                @error('patent_status')
                                    <small class="text-red-500">{{ $message }}</small>
                    ...
                    <button id="getCurrentLocation" class="btn btn-link float-left !m-0" type="button">Lấy vị trí hiện tại</button>
                </div>
